        ...
        <section className="h-full border-l-4 md:border-l-2 border-[#3476F1] px-5 pb-5 pt-20 md:p-0">
          <Margin>
            <div className="flex h-[50vh] w-full flex-col items-center justify-center gap-5 md:flex-row">
              <h2 data-aos="fade-right" className=" flex w-full flex-col items-center gap-5 text-4xl font-semibold text-white md:text-6xl">
                <span>Q U I E N E S</span>
                <span>S O M O S</span>
              </h2>
              <p data-aos="fade-left" className=" w-[90%] text-center text-white md:text-lg">
            ...
            <div data-aos="fade-up" className="flex md:h-[50vh] w-full items-center justify-center pt-20 md:pb-20">
              <Image
                src={img2}
                alt="..."
                width={897}
