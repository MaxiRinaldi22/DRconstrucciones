...
export default function Footer() {
  return (
    <footer className="h-full w-full bg-[#1F1F1F] md:h-[16vh]">
      <Margin>
        <div className="flex w-full flex-col items-center justify-between gap-2 py-2  text-neutral-600 md:flex-row md:gap-0 md:py-0">
          ...
          <hr className="md:md:h-[80px] md:border md:border-[#3476F1]" />
          <div className="flex w-full flex-col items-center justify-center gap-2 text-xl">
            <p className="text-xl text-neutral-500">Contactanos</p>
          ...
          <div className="flex w-full flex-col items-center pb-5 justify-center gap-3">
            <p className="text-xl text-neutral-500">Seguinos en</p>
            <div className="flex items-center gap-3">
              {iconsConst.map((icon) => (
                <Link href={icon.href} key={icon.href}>
                  <Icons path={icon.path} width={35} color="#737373" />
                </Link>
              ))}
            </div>
          </div>
